...
@section('scripts')
    ...
    <!-- Vector map-->
    <script src="{{ asset('administrator/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
    <script src="{{ asset('administrator/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>

    <!--Swiper slider js-->
    <script src="{{ asset('administrator/assets/libs/swiper/swiper-bundle.min.js') }}"></script>
