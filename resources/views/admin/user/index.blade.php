                    ...
                    <div class="card-body border-bottom-dashed border-bottom">
                        <div class="row g-3">
                            <div class="col-xl-6">
                                ...
                                <div>
                                    {{-- @if ($users->isEmpty())
                                    <p>Không tìm thấy người dùng với vai trò này.</p>
                                @else --}}
                                    {{-- <ul>
                                        @foreach ($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($user->role == 'customer')
                                                    <span class="badge bg-info-subtle text-primary">Nhan vien</span>
                                                @else
                                                    <span class="badge bg-warning-subtle text-success">Khach hang</span>
                                                @endif
