                            ...
                            <div class="dropdown dropdown-cart">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="total_drop">
                                        ...
                                        <a href="{{ route('cart.index') }}" class="btn_1 outline">View Cart</a><a
                                            href="{{ route('cart.checkout') }}" class="btn_1">Checkout</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /dropdown-cart-->
                            ...
                            <div class="dropdown dropdown-access">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('user.order') }}"><i class="ti-package"></i>My
                                                Orders</a>
                                        </li>
                                        <li>
                                            <a href="{{ route('user.profile') }}"><i class="ti-user"></i>My
                                                Profile</a>
                                        </li>
                                        @if (\Auth::check())
                                            <li>
